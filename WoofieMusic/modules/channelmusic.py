...
from WoofieMusic.modules.play import generate_cover
from WoofieMusic.modules.play import arq
from WoofieMusic.modules.play import cb_admin_check
from WoofieMusic.modules.play import transcode
from WoofieMusic.modules.play import convert_seconds
from WoofieMusic.modules.play import time_to_seconds
from WoofieMusic.modules.play import changeImageSize
from WoofieMusic.config import BOT_NAME as bn
from WoofieMusic.config import DURATION_LIMIT
from WoofieMusic.config import UPDATES_CHANNEL as updateschannel
from WoofieMusic.config import que
from WoofieMusic.function.admins import admins as a
...
from WoofieMusic.services.callsmusic import callsmusic, queues
...
from WoofieMusic.services.downloaders import youtube
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @WoofieMusic to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
